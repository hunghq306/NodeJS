...
getPromise1()
  ...
  .catch(function(e){console.log("=== Catch handler " + e)}); // run (whatever reject or throws)

getPromise2()
  .then(function(finalResult){console.log("Final result " + finalResult)})
  .error(function(e){console.log("Error handler " + e)})
  .catch(function(e){console.log("Catch handler " + e)}); // run (since 'throws new Error')

try {
  // this is ugly, we want to avoid this!
  // throw Error outside of Promise function;
  getPromise3()
    .then(function(finalResult){console.log("Final result " + finalResult)})
    .error(function(e){console.log("Error handler " + e)})
...
getPromise4()
  .then(function(finalResult){console.log("Final result " + finalResult)})
  .error(function(e){console.log("Error handler " + e)})
  .catch(function(e){console.log("Catch handler " + e)}); // run since reject

 */


getPromise('something')
  .then(function(finalResult){console.log("Final result " + finalResult)}) // run
  .error(function(e){console.log("Error handler " + e)})
  .catch(function(e){console.log("Catch handler " + e)});
